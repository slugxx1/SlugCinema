return {
  ...
  { id = "conquestsuperman2", title = "Conquest vs Superman (ULTRA HIGH FPS)", fps = 45 },
  ...
  { id = "soldierboyhigh", title = "Soldier Boy Zaza Clip (ULTRA HIGH FPS)", fps = 45 },
  { id = "summrs_prove_sum_mv", title = "summrs - prove sum MV", fps = 12 },
  { id = "rollinggiant", title = "The Rolling Giant Kane Pixels", fps = 12 },
  { id = "soldierboy2", title = "XQC Meat Canyon (ULTRA HIGH FPS)", fps = 45 },
}
